  ...
  return (
    <PageLayout>
      <Routes>
        ...
        <Route path="/admin/orders" element={<RequireRole user={currentUser} allowedRoles={['admin']}><AdminDashboard /></RequireRole>} />
        <Route path="/admin/customers" element={<RequireRole user={currentUser} allowedRoles={['admin']}><AdminDashboard /></RequireRole>} />
        <Route path="/admin/analytics" element={<RequireRole user={currentUser} allowedRoles={['admin']}><AdminDashboard /></RequireRole>} />
        <Route path="/admin/profile" element={<RequireRole user={currentUser} allowedRoles={['admin']}><AdminDashboard /></RequireRole>} />
